                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" class="select2 form-control">
                                                            <optgroup label="من فضلك أختر القسم الرئيسى">
                                                                @if($main_cats && $main_cats -> count() > 0 )
                                              ...
                                              @if(get_languages() -> count() > 0)
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">   اسم القسم الفرعى {{__('messages.'.$lang -> abbr)}}  </label>
                                                            <input type="text" value="" id="name"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="subcategory[{{$index}}][name]">
                                                            @error("subcategory.$index.name")
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$lang -> abbr}}" id="name"
                                                                   class="form-control"
                                                                   placeholder=""
                                                                   name="subcategory[{{$index}}][abbr]">
                                                            @error("subcategory.$index.abbr")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox"  value="1" name="subcategory[{{$index}}][active]"
                                                                   id="switcheryColor4"
                                                                   class="switchery" data-color="success"
                                                                   checked/>
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">    الحالة {{__('messages.'.$lang -> abbr)}} </label>
                                                            @error("subcategory.$index.active")
